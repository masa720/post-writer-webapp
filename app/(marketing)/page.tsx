...
export default function IndexPage() {
  return (
    <>
      <section className="pt-6 md:pt-10 lg:py-32 pb-8 md:pb-12">
        <div className="container text-center flex flex-col items-center gap-4 max-w-[64rem] mx-auto">
          ...
          <p className="text-muted-foreground sm:text-xl leading-normal max-w-[42rem]">
            ...
            Routerで作られたものです。ユーザーは自由に投稿を作成することができます。
          </p>
      ...
      <section
        id="features"
        className="container bg-slate-50 py-8 md:py-12 lg:py-24 space-y-6 mx-auto"
      >
        ...
        <div className="mx-auto grid sm:grid-col-2 md:grid-cols-3 gap-4 md:max-w-[64rem] px-10">
